...
public class FieldConstants {
    ...
    public static final double
            FIELD_WIDTH = 8.052, HALF_FIELD_WIDTH = FIELD_WIDTH / 2,
            FIELD_LENGTH = 16.541, HALF_FIELD_LENGTH = FIELD_LENGTH / 2,
    ...
    public static final Zone BOTTOM_TRENCH = new Zone(3.770766, 5.438766, 0, 1.265);
    public static final Zone BOTTOM_TRENCH_AREA = new Zone(3.770766-0.8, 5.438766+0.8, 0, 1.265+0.3f);
    ...
    public static final FlippablePose2d BALLS_BOTTOM_START = new FlippablePose2d(new Pose2d(7.824, 1.265, Rotation2d.kCW_90deg), false, true);
    public static final FlippablePose2d BALLS_TOP_START = new FlippablePose2d(new Pose2d(7.824, FIELD_WIDTH-1.265, Rotation2d.kCCW_90deg), false, true);
