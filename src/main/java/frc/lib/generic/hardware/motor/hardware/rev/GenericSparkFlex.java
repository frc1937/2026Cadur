    ...
    protected void handleSmoothMotion(MotorUtilities.MotionType motionType,
        ...
        switch (motionType) {
            ...
            case POSITION_TRAPEZOIDAL -> {
                ...
                sparkController.setSetpoint(currentSetpoint.position,
            ...
            case VELOCITY_TRAPEZOIDAL -> {
                ...
                sparkController.setSetpoint(currentSetpoint.position * 60,
            ...
            case POSITION_S_CURVE -> {
                ...
                sparkController.setSetpoint(scurveOutput.new_position,
